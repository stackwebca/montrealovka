...
$config["script_url"] = "http://xrub.net/pvt/";
/************************ database ************************/
//Set the host name to connect for database
/* $config["hostname"] =  "localhost"; */
//$config["hostname"] =  "144.217.242.80";
$config["hostname"] =  "localhost";
//Set the database name
$config["database"] = "xrub_services";
//Set the username for database access
$config["username"] = "jrsm_super";
//Set the pwd for the database user
$config["password"] = "89297e2ce464e766439d2c31f9c7d02ef30090a4";
...
$config["purchase_code"] = "d34e4dd1-5b3a-4444-8720-43071ac9da76";
