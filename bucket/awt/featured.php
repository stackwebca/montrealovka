...
<header>
  ...
  <container class="nav_container">
    <nav class="topnav" id="myTopnav">
      ...
      <a href="featured.php" class="active">Featured</a>
...
<main>
    <div id="mainContainer">
                ...
                <div class="mGridC">
                    <div class="mGridImages">
                      ...
                      <img onclick="F6()" id="F6" class="sidepics" src="img/F6.jpg"/>
                        <img onclick="F10()" id="F10" class="sidepics" src="img/F6.jpg"/>
                      <img src="img/BN1.jpg"/>
                    </div>
                </div>
            </div>
        ...
        <div class="mGridBigPic">
            <container class="profileimg">
              <div class=" overlay-imagef _bp ">
                <img class=" image _bq " src="./img/bigF8.jpg" id="bigImage"/>
        ...
        <div class="mGridBio">
            <container class="profileBioFeat">
                <div id="innerBio">
