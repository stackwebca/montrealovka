...
<head>
  ...
  <title>Sexy females and beautiful models, gorgeous women are available for your marketing campaign"</title>
  <meta name="description" content="Are you looking for beautiful female models?  Click the link to hire the hottest female models available for your advertising campaign.">
...
<main>
    <div id="mainContainer">
        ...
        <div class="mGridBigPic">
            <container class="profileimg">
              <div class=" overlay-imagef _bp ">
                <img class=" image _bq " src="./img/bigF11.jpg" id="bigImage"/>
        ...
        <div class="mGridBio" id="altBio">
            <container class="profileBioAlt">
                <div id="innerBio">
                    ...
                    // Set Variables
                    $userid = "7";  // <-- This ID sets the details - must set with javascript
                    $id = "$userid";
                    $strid = strval($id);
