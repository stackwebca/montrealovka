...
<head>
  ...
  <title>Hot masculine chiselled male models, hire the most handsome men for your marketing campaign."</title>
  <meta name="description" content="Are you looking for the finest male models for your marketing, click the link to see the sexiest men available for your advertising campaign">
...
<main>
    <div id="mainContainer">
        ...
        <div class="mGridBigPic">
            <container class="profileimg">
              <div class=" overlay-imagef _bp ">
                <img class=" image _bq " src="./img/bigM3.jpg" id="bigImage"/>
        ...
        <div class="mGridBio">
            <container class="profileBioAltm">
                <div id="innerBio">
                    ...
                    // Set Variables
                    $userid = "8";  // <-- This ID sets the details - must set with javascript
                    $id = "$userid";
                    $strid = strval($id);
                        ...
                        <form method="post" role="form">
                         ...
                         <span class="glyphicon glyphicon-calendar"></span>
                            ...
                            <div style="padding: .5em">
                                <input type="submit" name="submit" class="btn btn-success" value="Book Now!" style="width:13em; text-align:center; background: #33C3F0; "/>
                            </div>
