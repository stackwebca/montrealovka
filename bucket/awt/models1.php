  ...
  <div id="mainContainer">
    ...
    <div class="mGridBigPic">
      <container class="profileimg">
        ...
        <img class=" image _bq " src="./img/female_lg1.jpg" id="bigImage"/>
      ...
      <container class="bookme">
        <h3 id="bookthis">Book This Model</h3>
          ...
          <form method="post" role="form">
            ...
            <div class="form-group" align="left" style="float:none">
              ...
              <div class='input-group date' id='datetimepicker1' style="color:black; float:none">
                <input id="datetime" type='text' name="datetime" class="form-control" placeholder="desired time"
            ...
            <div class="form-group">
                                <textarea id="msgbox" name="message" rows="5" class="form-control"
                                          placeholder="message..."><?php echo $_POST['message']; ?></textarea>
            </div>
            <div>
              <label id="human" class="readable" style="width:100%; text-align: left">I am human</label>
              <div style="width:2em">
                <input id="check" type="checkbox" name="check" style="text-align: left">
              </div>
            </div>
            <div style="padding: .5em">
              <input id="button" type="submit" name="submit" class="btn btn-success" value="Book Now!"
                     style="width:13em; text-align:center; background: #f0ace6; "/>
            </div>
            <div id="table" class='table-responsive-sm' id='schedule' align='center'>
