                    ...
                    <div class="row">
                                ...
                                <div class="col-sm-12 text-left">
                                    ...
                                    <div class="panel-group directorycontainer" id="accordion">
                                        ...
                                        while ($getcategory_data = mysqli_fetch_assoc($query)) {
                                            ...
                                            if ($adnumquery = mysqli_query($conn, "SELECT * FROM site_usradverts WHERE ad_category LIKE '$showCategory'")) {
                                                $adnumrow_cnt = mysqli_num_rows($adnumquery);
                        ...
                        <div class="col-md-8 myAdListings">
                            ...
                            <div class="row">
                                ...
                                <span class="h4" style="margin:.1em; padding-left:.9em; font-size:.8em;
                                color:blue"><input type="radio" name="adradio" value="%" style="margin-right:.2em;">все</span>
                                    ...
                                    OR ad_title LIKE '$chosen' OR ad_content LIKE '$chosen' limit " . $start . " , " . $perPage . " ";
                                        ...
                                        while ($row = $adrows->fetch_assoc()) {
                                            print '<tr><td><div class="panel panel-default filtered adresults panel_ads"' .
                                                ...
                                                . "</p><span style='line-height:.5em;';>" . $row["ad_content"] . '</span><span class="text-muted" style="font-size:.8em;">' . "<p></p>Phone:&nbsp" . $row["ad_tel"] . "&nbsp|  Email:&nbsp &nbsp" . $row["ad_email"] . "<br><div id='delAdBtn' class='row'><a id='" . $row['ad_id'] . "' href='admin_deletead.php?id=" . $row['ad_id'] . "' 
class='btn btn-danger btn-rounded btn-sm removeAdBtn' style='margin-left:1.2em; margin-top:.25em;' name='" . $row['ad_id'] .
                        "'value='" . $row['ad_id'] . "'></a></div></span></div></div></tr></td>";
                                        } ?>
                                    </div>
